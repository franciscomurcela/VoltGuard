...
\begin{tabularx}{0.95\textwidth}{l c >{\raggedright\arraybackslash}X}
\toprule
...
\begin{itemize}[noitemsep]
  \item \textbf{Sensors} — unique identifier, location, firmware version, last-seen timestamp.
...
To validate that the platform tolerates pod failures during live traffic, a resilience test was performed with simultaneous pod termination under load. The terminal captures below show the full lifecycle as it happened.
